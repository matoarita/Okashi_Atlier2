		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(20); p.topping06 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(21); p.topping07 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(22); p.topping08 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(23); p.topping09 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(24); p.tp_score01 = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(25); p.tp_score02 = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(26); p.tp_score03 = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(27); p.tp_score04 = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(28); p.tp_score05 = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(29); p.tp_score06 = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(30); p.tp_score07 = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(31); p.tp_score08 = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(32); p.tp_score09 = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(33); p.Non_tpscore = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(34); p.desc = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(35); p.commet_flag = (int)(cell == null ? 0 : cell.NumericCellValue);
						s.list.Add (p);
					}
					data.sheets.Add(s);
				}
