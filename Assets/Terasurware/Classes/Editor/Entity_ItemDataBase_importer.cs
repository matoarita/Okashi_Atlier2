		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(25); p.SP_wind = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(26); p.type = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(27); p.subtype = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(28); p.subtypeB = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(29); p.subtype_category = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(30); p.base_score = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(31); p.girl1_like = (float)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(32); p.cost_price = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(33); p.sell_price = (int)(cell == null ? 0 : cell.NumericCellValue);
					...
					cell = row.GetCell(39); p.topping06 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(40); p.topping07 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(41); p.topping08 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(42); p.topping09 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(43); p.topping10 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(44); p.koyu_topping1 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(45); p.koyu_topping2 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(46); p.koyu_topping3 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(47); p.koyu_topping4 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(48); p.koyu_topping5 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(49); p.item_hyouji = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(50); p.Set_JudgeNum = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(51); p.Rare = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(52); p.Manpuku = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(53); p.SecretFlag = (int)(cell == null ? 0 : cell.NumericCellValue);
						s.list.Add (p);
					}
					data.sheets.Add(s);
				}
