		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(36); p.best_welldone = (float)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(37); p.type = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(38); p.subtype = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(39); p.subtypeB = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(40); p.subtype_category = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(41); p.base_score = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(42); p.girl1_like = (float)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(43); p.cost_price = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(44); p.sell_price = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(45); p.topping01 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(46); p.topping02 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(47); p.topping03 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(48); p.topping04 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(49); p.topping05 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(50); p.topping06 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(51); p.topping07 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(52); p.topping08 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(53); p.topping09 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(54); p.topping10 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(55); p.koyu_topping1 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(56); p.koyu_topping2 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(57); p.koyu_topping3 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(58); p.koyu_topping4 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(59); p.koyu_topping5 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(60); p.item_hyouji = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(61); p.Set_JudgeNum = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(62); p.Rare = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(63); p.Manpuku = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(64); p.Magic = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(65); p.Attribute1 = (int)(cell == null ? 0 : cell.NumericCellValue);
