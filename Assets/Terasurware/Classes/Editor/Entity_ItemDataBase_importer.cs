		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(8); p.rich = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(9); p.sweat = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(10); p.bitter = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(11); p.sour = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(12); p.crispy = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(13); p.fluffy = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(14); p.smooth = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(15); p.hardness = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(16); p.jiggly = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(17); p.chewy = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(18); p.powdery = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(19); p.oily = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(20); p.watery = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(21); p.type = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(22); p.subtype = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(23); p.girl1_like = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(24); p.cost_price = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(25); p.sell_price = (int)(cell == null ? 0 : cell.NumericCellValue);
					...
					cell = row.GetCell(31); p.topping06 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(32); p.topping07 = (cell == null ? "" : cell.StringCellValue);
