		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(25); p.type = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(26); p.subtype = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(27); p.subtype_category = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(28); p.base_score = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(29); p.girl1_like = (float)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(30); p.cost_price = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(31); p.sell_price = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(32); p.topping01 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(33); p.topping02 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(34); p.topping03 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(35); p.topping04 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(36); p.topping05 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(37); p.topping06 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(38); p.topping07 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(39); p.topping08 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(40); p.topping09 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(41); p.topping10 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(42); p.koyu_topping1 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(43); p.koyu_topping2 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(44); p.koyu_topping3 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(45); p.koyu_topping4 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(46); p.koyu_topping5 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(47); p.item_hyouji = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(48); p.Set_JudgeNum = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(49); p.Rare = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(50); p.Manpuku = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(51); p.SecretFlag = (int)(cell == null ? 0 : cell.NumericCellValue);
						s.list.Add (p);
					}
					data.sheets.Add(s);
				}
