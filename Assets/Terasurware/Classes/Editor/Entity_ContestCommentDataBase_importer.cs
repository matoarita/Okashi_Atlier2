...
public class Entity_ContestCommentDataBase_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Resources/Excel/Entity_ContestCommentDataBase.xlsx";
	private static readonly string exportPath = "Assets/Resources/Excel/Entity_ContestCommentDataBase.asset";
	private static readonly string[] sheetNames = { "01_ContestComment","02_ConComment_D01","02_ConComment_D100","02_ConComment_SPScore", };
