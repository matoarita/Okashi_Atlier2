		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(5); p.Contest_EnshutuName = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(6); p.theme_comment = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(7); p.Contest_Pmonth = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(8); p.Contest_Pday = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(9); p.Contest_Endmonth = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(10); p.Contest_Endday = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(11); p.Contest_cost = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(12); p.Contest_flag = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(13); p.Contest_PatissierRank = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(14); p.Contest_Lv = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(15); p.Contest_BringType = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(16); p.Contest_BringMax = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(17); p.Contest_RankingType = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(18); p.Contest_Accepted = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(19); p.GetPatissierPoint = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(20); p.ContestVictory = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(21); p.ContestFightsCount = (int)(cell == null ? 0 : cell.NumericCellValue);
