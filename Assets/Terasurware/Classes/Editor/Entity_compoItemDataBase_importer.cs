		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(19); p.cmp_systemflag = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(20); p.cost_time = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(21); p.success_rate = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(22); p.renkin_Bexp = (int)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(23); p.Comment = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(24); p.Comment2 = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(26); p.KeisanMethod = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(27); p.comp_count = (int)(cell == null ? 0 : cell.NumericCellValue);
