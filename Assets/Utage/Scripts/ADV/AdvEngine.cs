...
namespace Utage
{
	...
	{
        //文字ページ送ったときの効果音
        private GameObject hitsound_obj;
        private AudioSource hitsound01;
		...
		public AdvEvent OnPageTextChange {
            ...
            get {
                ...
                hitsound_obj = GameObject.FindWithTag("AudioClickSE");
                hitsound01 = hitsound_obj.GetComponent<AudioSource>();

                hitsound01.PlayOneShot(hitsound01.clip);
