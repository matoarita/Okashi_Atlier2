...
public class Hiroba_Main3 : MonoBehaviour
{
    //
    //** 広場スクリプト **
    //
    ...
    void Start()
    {
        ...
        //3番街関連トグル
        hiroba3_back_toggle_obj = mainlist_controller_obj.transform.Find("Viewport/Content_Main/hiroba3_Back_SelectToggle").gameObject;
        hiroba3_back_toggle = hiroba3_back_toggle_obj.GetComponent<Toggle>();

        //最初はoff
        npc1_toggle_obj.SetActive(false);
    ...
    void ToggleFlagCheck()
    {
        ...
        if (GameMgr.Story_Mode != 0)
        {
            ...
            {
                npc1_toggle_obj.SetActive(true);
            }
        }
        else
        {
