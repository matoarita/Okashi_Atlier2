...
public class GirlLikeSetDataBase : SingletonMonoBehaviour<GirlLikeSetDataBase>
{
    ...
    void SetExcelDB()
    {
        ...
        _tp06 = excel_girlLikeset_database.sheets[sheet_no].list[count].topping06;
        _tp07 = excel_girlLikeset_database.sheets[sheet_no].list[count].topping07;
        _tp08 = excel_girlLikeset_database.sheets[sheet_no].list[count].topping08;
        _tp09 = excel_girlLikeset_database.sheets[sheet_no].list[count].topping09;
        ...
        _tp_score06 = excel_girlLikeset_database.sheets[sheet_no].list[count].tp_score06;
        _tp_score07 = excel_girlLikeset_database.sheets[sheet_no].list[count].tp_score07;
        _tp_score08 = excel_girlLikeset_database.sheets[sheet_no].list[count].tp_score08;
        _tp_score09 = excel_girlLikeset_database.sheets[sheet_no].list[count].tp_score09;
        ...
        _search_endflag = excel_girlLikeset_database.sheets[sheet_no].list[count].search_endflag;
