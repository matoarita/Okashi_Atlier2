...
public class Sound_Trigger : MonoBehaviour {
    ...
    void Set_Check_SE()
    {
        switch (transform.name)
        {
            ...
            case "Back_ShopFirst": //noを押したときのSE
            ...
            case "QuickSaveButton": //クイックセーブを押したときのSE
            ...
            case "StarKakuninButton": //スターパネル開くときの音
            ...
            case "Quest_PlaceButton": //yesを押したときのSE
            ...
            default: //特に指定がない場合
                ...
                //クリックしたときに鳴る音
                SE_point_click(23); //0 or 23(カッ) or 30（ぽこ）
                break;
