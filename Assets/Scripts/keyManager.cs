...
public class keyManager : SingletonMonoBehaviour<keyManager>
{
    ...
    void InitCompoundMainScene()
    {
        ...
        compobgA = canvas.transform.Find("CompoundMainController/Compound_BGPanel_A").gameObject;
        ...
        toggle_list.Clear();
        foreach(Transform child in canvas.transform.Find("MainUIPanel/Comp/CompoundSelect_ScrollView/Viewport/Content_compound").transform)
        {
