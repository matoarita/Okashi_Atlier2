...
public class GirlLikeCompo
{
    ...
    public GirlLikeCompo(int id, int _set_id, int set1_id, int set2_id, int set3_id, string _quest_name1, string _quest_name2, string _quest_name3, string _desc, string _comment, int _set_flag, int _set_score, string _hint, bool clear_flag)
    {
        ID = id;
        set_ID = _set_id;
