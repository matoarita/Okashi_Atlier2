    ...
    void Start()
    {
        ...
        switch (GameMgr.SceneSelectNum)
        {
            ...
            case 14: //春エリア　露店通り
                ...
                GameMgr.Scene_Name = "Or_Hiroba_Spring_RotenStreet";
                SettingBGPanel("Map08"); //Map〇〇のリスト番号を指定
                break;

            case 15: //春エリア　露店通り2

                GameMgr.Scene_Name = "Or_Hiroba_Spring_RotenStreet2";
                SettingBGPanel("Map09"); //Map〇〇のリスト番号を指定
                break;

            case 16: //春エリア　酒場通り

                GameMgr.Scene_Name = "Or_Hiroba_Spring_BarStreet";
                SettingBGPanel("Map13"); //Map〇〇のリスト番号を指定
                break;

            case 17: //春エリア　奥側　右の小道

                GameMgr.Scene_Name = "Or_Hiroba_Spring_Flower_Campo";
                SettingBGPanel("Map12"); //Map〇〇のリスト番号を指定
                break;

            case 20: //春エリア　裏通り奥の庭

                GameMgr.Scene_Name = "Or_Hiroba_Spring_Oku_Garden";
                SettingBGPanel("Map10"); //Map〇〇のリスト番号を指定
                break;

            case 21: //春エリア　離れの草原

                GameMgr.Scene_Name = "Or_Hiroba_Spring_Out_Plain";
                SettingBGPanel("Map11"); //Map〇〇のリスト番号を指定
                break;

            case 22: //春エリア　静けさの湖　ミラボー先生の家前

                GameMgr.Scene_Name = "Or_Hiroba_Spring_Out_MagicHouseLake";
                SettingBGPanel("Map20"); //Map〇〇のリスト番号を指定
                break;

            case 23: //春エリア　祭壇

                GameMgr.Scene_Name = "Or_Hiroba_Spring_Out_alter";
                SettingBGPanel("Map14"); //Map〇〇のリスト番号を指定
                break;

            case 24: //春エリア　露店通り右の広場　使ってない

                GameMgr.Scene_Name = "Or_Hiroba_Spring_RotenStreet3";
                SettingBGPanel("Map15"); //Map〇〇のリスト番号を指定
                break;
            ...
            case 175: //夏エリア  １３番街　奥
                ...
                SettingBGPanel("Map175"); //Map〇〇のリスト番号を指定
                break;

            case 176: //夏エリア  １３番街　浜辺エリア

                GameMgr.Scene_Name = "Or_Hiroba_Summer_ThemePark_beachMae";
                SettingBGPanel("Map176"); //Map〇〇のリスト番号を指定
                break;

            case 177: //夏エリア  １３番街　イケメンのお店前

                GameMgr.Scene_Name = "Or_Hiroba_Summer_CakeShop_Mae";
                SettingBGPanel("Map177"); //Map〇〇のリスト番号を指定
                break;
            ...
            case 403: //オランジーナ大広場
                ...
                GameMgr.Scene_Name = "Or_Hiroba_MainGate_Big_hiroba";
                SettingBGPanel("Map403"); //Map〇〇のリスト番号を指定
