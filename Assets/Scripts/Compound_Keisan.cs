...
public class Compound_Keisan : SingletonMonoBehaviour<Compound_Keisan>
{
    ...
    private int delete_base_kosu;
    private int delete_kosu1;
    private int delete_kosu2;
    private int delete_kosu3;
    ...
    public int _baseattri4;
    public int _baseattri5;
    public int _baseattri6;
    public int _baseattri7;
    public int _baseattri8;
    public int _baseattri9;
    public int _baseattri10;
    ...
    void SetParamInit()
    {
        ...
        if (Comp_method_bunki == 0) //オリジナル調合の場合
        {
            ...
            //セット数　updowncounterの値をもとにCompound_Checkで設定してる。
        ...
        if (Comp_method_bunki == 2) //レシピ調合の場合 通常の場合の処理　魔法を使ったレシピの場合、ここは通らず、下の魔法調合=20を直接通る
        {
        ...
        if (Comp_method_bunki == 3) //トッピング調合の場合
        {
            ...
            base_kosu = GameMgr.Final_kettei_basekosu;
            final_kette_kosu1 = GameMgr.Final_kettei_kosu1;
            final_kette_kosu2 = GameMgr.Final_kettei_kosu2;
            final_kette_kosu3 = GameMgr.Final_kettei_kosu3;
        ...
        if (Comp_method_bunki == 20 || Comp_method_bunki == 22) //魔法調合の場合　アイテムDBに、あえて空のアイテムデータを用意し、それを計算する 他、処理はオリジナルと一緒
        {
            ...
            //final_select_kaisu = exp_Controller.set_kaisu;
            final_select_kaisu = 1; //魔法はセット数を選ばない
            ...
            //一個目に選んだアイテムをベースに、リザルトアイテムにする。
        {
            switch (base_toggle_type)
            {
                ...
                case 1: //オリジナルプレイヤーアイテムリストから選択している場合
                    ...
                    _baseattri4 = pitemlist.player_originalitemlist[_id].Attribute4;
                    _baseattri5 = pitemlist.player_originalitemlist[_id].Attribute5;
                    _baseattri6 = pitemlist.player_originalitemlist[_id].Attribute6;
                    _baseattri7 = pitemlist.player_originalitemlist[_id].Attribute7;
                    _baseattri8 = pitemlist.player_originalitemlist[_id].Attribute8;
                    _baseattri9 = pitemlist.player_originalitemlist[_id].Attribute9;
                    _baseattri10 = pitemlist.player_originalitemlist[_id].Attribute10;
                ...
                case 2: //お菓子パネルアイテムリストから選択している場合
                    ...
                    _baseattri4 = pitemlist.player_extremepanel_itemlist[_id].Attribute4;
                    _baseattri5 = pitemlist.player_extremepanel_itemlist[_id].Attribute5;
                    _baseattri6 = pitemlist.player_extremepanel_itemlist[_id].Attribute6;
                    _baseattri7 = pitemlist.player_extremepanel_itemlist[_id].Attribute7;
                    _baseattri8 = pitemlist.player_extremepanel_itemlist[_id].Attribute8;
                    _baseattri9 = pitemlist.player_extremepanel_itemlist[_id].Attribute9;
                    _baseattri10 = pitemlist.player_extremepanel_itemlist[_id].Attribute10;
    ...
    void Setup_Param01(int _status)
    {
        ...
        _baseattri4 = database.items[_id].Attribute4;
        _baseattri5 = database.items[_id].Attribute5;
        _baseattri6 = database.items[_id].Attribute6;
        _baseattri7 = database.items[_id].Attribute7;
        _baseattri8 = database.items[_id].Attribute8;
        _baseattri9 = database.items[_id].Attribute9;
        _baseattri10 = database.items[_id].Attribute10;
    ...
    void Setup_Param03()
    {
        ...
        _baseattri4 = database.items_gamedefault[_id].Attribute4;
        _baseattri5 = database.items_gamedefault[_id].Attribute5;
        _baseattri6 = database.items_gamedefault[_id].Attribute6;
        _baseattri7 = database.items_gamedefault[_id].Attribute7;
        _baseattri8 = database.items_gamedefault[_id].Attribute8;
        _baseattri9 = database.items_gamedefault[_id].Attribute9;
        _baseattri10 = database.items_gamedefault[_id].Attribute10;
    ...
    public void HikariMakeGetItem(int _status)
    {
        ...
        _baseattri4 = pitemlist.player_yosokuitemlist[_id].Attribute4;
        _baseattri5 = pitemlist.player_yosokuitemlist[_id].Attribute5;
        _baseattri6 = pitemlist.player_yosokuitemlist[_id].Attribute6;
        _baseattri7 = pitemlist.player_yosokuitemlist[_id].Attribute7;
        _baseattri8 = pitemlist.player_yosokuitemlist[_id].Attribute8;
        _baseattri9 = pitemlist.player_yosokuitemlist[_id].Attribute9;
        _baseattri10 = pitemlist.player_yosokuitemlist[_id].Attribute10;
    ...
    void Comp_ParamAddMethod()
    {
        ...
        if (Comp_method_bunki == 0 || Comp_method_bunki == 2 || Comp_method_bunki == 20 || Comp_method_bunki == 22)//オリジナル調合・レシピ調合・魔法　のときの計算。
        {
            ...
            if(_basemagic >= 1) { _basemagic = 1; } //1以上にはならない。
            ...
            if (keisan_method_flag == 1) //1=ベスト配合との距離の補正をかける。
            {
                ...
                else if (totalkyori >= 8.0 && totalkyori < 12.0)
                {
                    kyori_hosei = 0.5f;
                    kyori_hosei = bufpower_keisan.Buf_KyoriHosei_Keisan(kyori_hosei, _basename);
                }
                else if (totalkyori >= 12.0)
                {
                    kyori_hosei = 0.125f;
                    kyori_hosei = bufpower_keisan.Buf_KyoriHosei_Keisan(kyori_hosei, _basename);
                }
        ...
        if (Comp_method_bunki == 0 || Comp_method_bunki == 2)//オリジナル調合　または　レシピ調合　のときの計算。魔法のときはバフをかけない。Comp_method_bunki == 20
        {
            if (databaseCompo.compoitems[result_compID].buf_kouka_on != 0) //_before_itemtype_Sub != _base_itemType_sub クリーム系からまたクリーム系が出来る場合は、バフがかからないよう、重複防止処理
            {
                ...
                _basecrispy += bufpower_keisan.Buf_OkashiParamUp_Keisan(0, _basecrispy, _basename, result_compID, _basemagic); //中の数字でどの食感パラムかの指定
                _basefluffy += bufpower_keisan.Buf_OkashiParamUp_Keisan(1, _basefluffy, _basename, result_compID, _basemagic);
                _basesmooth += bufpower_keisan.Buf_OkashiParamUp_Keisan(2, _basesmooth, _basename, result_compID, _basemagic);
                _basehardness += bufpower_keisan.Buf_OkashiParamUp_Keisan(3, _basehardness, _basename, result_compID, _basemagic);
                _basejuice += bufpower_keisan.Buf_OkashiParamUp_Keisan(4, _basejuice, _basename, result_compID, _basemagic);
                _basebeauty += bufpower_keisan.Buf_OkashiParamUp_Keisan(5, _basebeauty, _basename, result_compID, _basemagic);
                _basetea_flavor += bufpower_keisan.Buf_OkashiParamUp_Keisan(6, _basetea_flavor, _basename, result_compID, _basemagic);
                _basepowdery += bufpower_keisan.Buf_OkashiParamUp_Keisan(50, _basepowdery, _basename, result_compID, _basemagic);
                _baseoily += bufpower_keisan.Buf_OkashiParamUp_Keisan(51, _baseoily, _basename, result_compID, _basemagic);
                _basewatery += bufpower_keisan.Buf_OkashiParamUp_Keisan(52, _basewatery, _basename, result_compID, _basemagic);


                //B. 固有のお菓子のみにバフをかける処理
                _basecrispy += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(0, _basename, _basecrispy); //中の数字でどの食感パラムかの指定
                _basefluffy += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(1, _basename, _basefluffy);
                _basesmooth += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(2, _basename, _basesmooth);
                _basehardness += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(3, _basename, _basehardness);
                _basejuice += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(4, _basename, _basejuice);
                _basebeauty += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(5, _basename, _basebeauty);
                _basetea_flavor += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(6, _basename, _basetea_flavor);
                _basepowdery += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(50, _basename, _basepowdery);
                _baseoily += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(51, _basename, _baseoily);
                _basewatery += bufpower_keisan.Buf_OkashiParamUp_ItemNameKeisan(52, _basename, _basewatery);

                //C. 特定の調合DBにのみバフをかける処理
                _basecrispy += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(0, databaseCompo.compoitems[result_compID].cmpitem_Name, _basecrispy); //中の数字でどの食感パラムかの指定
                _basefluffy += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(1, databaseCompo.compoitems[result_compID].cmpitem_Name, _basefluffy);
                _basesmooth += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(2, databaseCompo.compoitems[result_compID].cmpitem_Name, _basesmooth);
                _basehardness += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(3, databaseCompo.compoitems[result_compID].cmpitem_Name, _basehardness);
                _basejuice += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(4, databaseCompo.compoitems[result_compID].cmpitem_Name, _basejuice);
                _basebeauty += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(5, databaseCompo.compoitems[result_compID].cmpitem_Name, _basebeauty);
                _basetea_flavor += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(6, databaseCompo.compoitems[result_compID].cmpitem_Name, _basetea_flavor);
                _basepowdery += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(50, databaseCompo.compoitems[result_compID].cmpitem_Name, _basepowdery);
                _baseoily += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(51, databaseCompo.compoitems[result_compID].cmpitem_Name, _baseoily);
                _basewatery += bufpower_keisan.Buf_OkashiParamUp_CompoNameKeisan(52, databaseCompo.compoitems[result_compID].cmpitem_Name, _basewatery);
        ...
        if (GameMgr.System_HikariMakeUse_Flag)
        {
            ...
            if (mstatus == 2)
            {
                if (databaseCompo.compoitems[result_compID].buf_kouka_on != 0) //バフ計算するものだけ、バフ計算。例えばクッキー×ぶどう＝ぶどうクッキーのときは、バフ計算しない
                {
                    ...
                    _basecrispy += bufpower_keisan.Buf_HikariParamUp_Keisan(0, _base_itemType_sub, _basecrispy); //_base_itemType_subは未使用だが、とりあえず置いてる。
                    _basefluffy += bufpower_keisan.Buf_HikariParamUp_Keisan(1, _base_itemType_sub, _basefluffy);
                    _basesmooth += bufpower_keisan.Buf_HikariParamUp_Keisan(2, _base_itemType_sub, _basesmooth);
                    _basehardness += bufpower_keisan.Buf_HikariParamUp_Keisan(3, _base_itemType_sub, _basehardness);
                    _basejuice += bufpower_keisan.Buf_HikariParamUp_Keisan(4, _base_itemType_sub, _basejuice);
                    _basebeauty += bufpower_keisan.Buf_HikariParamUp_Keisan(5, _base_itemType_sub, _basebeauty);
                    _basetea_flavor += bufpower_keisan.Buf_HikariParamUp_Keisan(6, _base_itemType_sub, _basetea_flavor);
                    _basepowdery += bufpower_keisan.Buf_HikariParamUp_Keisan(50, _base_itemType_sub, _basepowdery);
                    _baseoily += bufpower_keisan.Buf_HikariParamUp_Keisan(51, _base_itemType_sub, _baseoily);
                    _basewatery += bufpower_keisan.Buf_HikariParamUp_Keisan(52, _base_itemType_sub, _basewatery);
                }
            }
        ...
        {
            //A. お菓子の食感ごとに、バフをかける処理
            _basecrispy += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(0, _basecrispy, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7); //中の数字でどの食感パラムかの指定
            _basefluffy += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(1, _basefluffy, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7);
            _basesmooth += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(2, _basesmooth, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7);
            _basehardness += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(3, _basehardness, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7);
            _basejuice += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(4, _basejuice, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7);
            _basebeauty += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(5, _basebeauty, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7);
            _basetea_flavor += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(6, _basetea_flavor, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7);
            _basepowdery += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(50, _basepowdery, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7);
            _baseoily += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(51, _baseoily, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7);
            _basewatery += bufpower_keisan.Buf_OkashiParamUp_MagicKeisan(52, _basewatery, GameMgr.UseMagicSkill, _baseattri2, _baseattri5, _baseattri6, _baseattri7);
    ...
    void Okashi_SpecialKeisan()
    {
        ...
        //ケーキベースは粉っぽさも減らす
        if (_base_itemType_subB == "a_Cake_MatBase" || _base_itemType_subB == "a_Cake_MatBaseNoUP") //
        {
    ...
    void Okashi_SpecialKeisan_Nomagic()
    {
        ...
        if(_base_itemType_sub == "Appaleil" || _base_itemType_sub == "Appaleil_Icecream")
        {
            ...
            _baseattri7 = GameMgr.Appaleil_Attribute[6]; //WarmingHandmaid回数を引継ぎ
        }
    }
    ...
    void AddMagicSlot_Method()
    {
        ...
        if (GameMgr.UseMagicSkill == "Fire_Ark")
        {
            _baseattri5++;
        }
        ...
        if (GameMgr.UseMagicSkill == "Warming_Handmade")
        {
            _baseattri7++;
        }
    }
    ...
    public void Delete_playerItemList(int _dstatus)
    {
        ...
        if (Comp_method_bunki == 1 || Comp_method_bunki == 3 || Comp_method_bunki == 22)             
        {
            delete_base_kosu = base_kosu * final_select_kaisu;
            ...
            switch (base_toggle_type)
            {
                case 0: //プレイヤーアイテムリストから選択している。
                    ...
                    {
                        pitemlist.deletePlayerItem(database.items[_id].itemName, delete_base_kosu);
                    }
                    break;
                ...
                case 1: //オリジナルアイテムリストから選択している。
                    ...
                    {
                        deleteOriginalList.Add(_id, delete_base_kosu);
                    }
                    break;
                ...
                case 2: //お菓子パネルアイテムリストから選択している。
                    ...
                    {
                        deleteExtremeList.Add(_id, delete_base_kosu);
                    }
                    break;
        ...
        //削除処理
        delete_kosu1 = final_kette_kosu1 * final_select_kaisu;
        delete_kosu2 = final_kette_kosu2 * final_select_kaisu;
        delete_kosu3 = final_kette_kosu3 * final_select_kaisu;
    ...
    void DeleteMethod1()
    {
        ...
        switch (toggle_type1)
        {
            case 0: //プレイヤーアイテムリストから選択している。ただちに削除
                ...
                {
                    pitemlist.deletePlayerItem(database.items[_id].itemName, delete_kosu1);
                }
                break;
            ...
            case 1: //オリジナルアイテムリストから選択している。オリジナルの場合は、一度削除用リストにIDを追加し、降順にしてから、後の削除メソッドでまとめて削除する。
                ...
                deleteOriginalList.Add(_id, delete_kosu1);
                break;
            ...
            case 2: //お菓子パネルリストから選択している。
                ...
                deleteExtremeList.Add(_id, delete_kosu1);
                break;
        ...
        if (kettei_item2 != 9999) //二個目のトッピングアイテムを選んでいなければ、この処理は無視する。
        {
            ...
            switch (toggle_type2)
            {
                case 0: //プレイヤーアイテムリストから選択している。
                    ...
                    {
                        pitemlist.deletePlayerItem(database.items[_id].itemName, delete_kosu2);
                    }
                    break;
                ...
                case 1: //オリジナルアイテムリストから選択している。オリジナルの場合は、一度削除用リストにIDを追加し、降順にしてから、後の削除メソッドでまとめて削除する。
                    ...
                    deleteOriginalList.Add(_id, delete_kosu2);
                    break;
                ...
                case 2: //お菓子パネルリストから選択している。
                    ...
                    deleteExtremeList.Add(_id, delete_kosu2);
                    break;
        ...
        if (kettei_item3 != 9999) //三個目のトッピングアイテムを選んでいなければ、この処理は無視する。
        {
            ...
            switch (toggle_type3)
            {
                case 0: //プレイヤーアイテムリストから選択している。
                    ...
                    {
                        pitemlist.deletePlayerItem(database.items[_id].itemName, delete_kosu3);
                    }
                    break;
                ...
                case 1: //オリジナルアイテムリストから選択している。オリジナルの場合は、一度削除用リストにIDを追加し、降順にしてから、後の削除メソッドでまとめて削除する。
                    ...
                    deleteOriginalList.Add(_id, delete_kosu3);
                    break;
                ...
                case 2: //お菓子パネルリストから選択している。
                    ...
                    deleteExtremeList.Add(_id, delete_kosu3);
                    break;
