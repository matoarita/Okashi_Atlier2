...
public class ContestPrizeScoreDataBase : SingletonMonoBehaviour<ContestPrizeScoreDataBase>
{
        ...
        else //ランキング形式の賞品獲得
        {
            ...
            while (i < 5) //5位まで判定
            {
                if (GameMgr.contest_Rank_Count == 5 - i) //5位
                {
                    ...
                    //賞金
                    if (GameMgr.System_ContestPastVictory_GetMoneyFlag) //過去優勝したことがあると賞金なしの仕様をオン
                    {                      
    ...
    void PrizeRankingSet02()
    {
        ...
        GameMgr.PrizeScoreAreaList.Add(371);
    ...
    void PrizeRankingSet06() //光ラスクか光チーズケーキ　光りジュース
    {
        ...
        GameMgr.PrizeItemList.Add("Non");
        GameMgr.PrizeItemList.Add("neko_badge2");
        GameMgr.PrizeItemList.Add("cookie_powerup4");
    ...
    void PrizeRankingSet08()
    {
        ...
        GameMgr.PrizeScoreAreaList.Add(512);
        GameMgr.PrizeScoreAreaList.Add(627);
        GameMgr.PrizeScoreAreaList.Add(751);
    ...
    void PrizeRankingSet10()
    {
        ...
        //相手の点数リスト
        GameMgr.PrizeScoreAreaList.Clear();
        GameMgr.PrizeScoreAreaList.Add(241);
        GameMgr.PrizeScoreAreaList.Add(385);
        GameMgr.PrizeScoreAreaList.Add(407);
        GameMgr.PrizeScoreAreaList.Add(470);
    ...
    void PrizeRankingSet22()
    {
        ...
        GameMgr.PrizeScoreAreaList.Add(108);
        GameMgr.PrizeScoreAreaList.Add(122);
    ...
    void PrizeRankingSet26()
    {
        ...
        GameMgr.PrizeGetMoneyList.Add(5555);
    ...
    void PrizeRankingSet28()
    {
        ...
        GameMgr.PrizeItemList.Add("Non");
        GameMgr.PrizeItemList.Add("Non");
        GameMgr.PrizeItemList.Add("otona_powerup1");
        ...
        GameMgr.PrizeScoreAreaList.Add(117);
        GameMgr.PrizeScoreAreaList.Add(143);
    ...
    void PrizeRankingSet29()
    {
        ...
        GameMgr.PrizeScoreAreaList.Add(141);
    ...
    void PrizeRankingSet40()
    {
        ...
        GameMgr.PrizeScoreAreaList.Add(109);
        GameMgr.PrizeScoreAreaList.Add(137);
    ...
    void PrizeRankingSet41()
    {
        ...
        GameMgr.PrizeScoreAreaList.Add(217);
        GameMgr.PrizeScoreAreaList.Add(262);
    ...
    void PrizeRankingSet45()
    {
        ...
        GameMgr.PrizeScoreAreaList.Add(299);
        GameMgr.PrizeScoreAreaList.Add(381);
    ...
    void PrizeRankingSet47()
    {
        ...
        GameMgr.PrizeScoreAreaList.Add(196);
        GameMgr.PrizeScoreAreaList.Add(205);
        GameMgr.PrizeScoreAreaList.Add(324);
    ...
    void PrizeRankingSet49()
    {
        ...
        GameMgr.PrizeItemList.Add("Non");
        GameMgr.PrizeItemList.Add("Non");
        GameMgr.PrizeItemList.Add("crepe_powerup3");
    ...
    void PrizeRankingSet63()
    {
        ...
        //相手の点数リスト
        GameMgr.PrizeScoreAreaList.Clear();
        GameMgr.PrizeScoreAreaList.Add(167);
        GameMgr.PrizeScoreAreaList.Add(198);
        GameMgr.PrizeScoreAreaList.Add(210);
        GameMgr.PrizeScoreAreaList.Add(273);
    ...
    void PrizeRankingSet61()
    {
        ...
        GameMgr.PrizeGetMoneyList.Add(3000);
        GameMgr.PrizeGetMoneyList.Add(6000);
        GameMgr.PrizeGetMoneyList.Add(12000);
