...
public class magicskillLearnToggle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        yes_no_panel = canvas.transform.Find("CompoundMainController/Compound_BGPanel_A/MagicLearnPanel/Yes_no_Panel_Finalcheck").gameObject;
    ...
    public void skill_learn_active()
    {
        ...
        magicskilllistController.skill_kettei_ID = magicskilllistController._skill_listitem[count].GetComponent<magicskillLearnToggle>().toggle_skill_ID; //IDを入れる。
        magicskilllistController.skill_Type = magicskilllistController._skill_listitem[count].GetComponent<magicskillLearnToggle>().toggle_skill_type; //
        magicskilllistController.skill_Name = magicskilllistController._skill_listitem[count].GetComponent<magicskillLearnToggle>().toggle_skill_name; //使用するスキル英字ネーム
        _item_Namehyouji = magicskilllistController._skill_listitem[count].GetComponent<magicskillLearnToggle>().toggle_skill_nameHyouji; //表示用ネームを入れる。
    ...
    void SkillCheck_Method()
    {
        for (i = 0; i < magicskilllistController._skill_listitem.Count; i++)
        {
            ...
            magicskilllistController.LearnHyouji_ONOFF(i, magicskilllistController._skill_listitem[i].GetComponent<magicskillLearnToggle>().toggle_skill_ID);
        }
    ...
    void SkillLearnLibrary()
    {        
        //習得処理
        magicskill_database.magicskill_lists[GameMgr.UseMagicSkill_ID].skillLv++;
        //上限処理
        if (magicskill_database.magicskill_lists[GameMgr.UseMagicSkill_ID].skillLv > magicskill_database.magicskill_lists[GameMgr.UseMagicSkill_ID].skillMaxLv)
        {
            magicskill_database.magicskill_lists[GameMgr.UseMagicSkill_ID].skillLv = magicskill_database.magicskill_lists[GameMgr.UseMagicSkill_ID].skillMaxLv;
        }
        magicskilllistController.ReDraw();
